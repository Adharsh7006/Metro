# Generated by Django 4.0.6 on 2022-11-08 08:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment', to='metro_app.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Health',
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health', to='metro_app.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Complaint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField()),
                ('time', models.TimeField()),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendance', to='metro_app.customer')),
            ],
        ),
    ]
